...
import EntityAlias = Levelup.V2.Cm.Entity.Review;
import ApiAlias = Levelup.V2.Cm.Api.Reviews;
import DocumentAlias = Levelup.V2.Cm.Model.ReviewDocument;
import EventPayloadsAlias = Levelup.V2.Events.Payloads.Cm.Review;
  ...
  */
  ...
  public async create(
    ...
    try {
      ...
      this.eventDispatcher.dispatch<EventPayloadsAlias.created>(events.cm.review.created, { data: doc });
  ...
  */
  public async update(
    ...
    try {
       ...
       */
      this.eventDispatcher.dispatch<EventPayloadsAlias.updated>(events.cm.review.updated, { data: doc });
  ...
  */
  public async delete(
    ...
    try {
      ...
      this.eventDispatcher.dispatch<EventPayloadsAlias.deleted>(events.cm.review.deleted, { data: doc });
  ...
  */
  public async restore(
    ...
    try {
      ...
      this.eventDispatcher.dispatch<EventPayloadsAlias.deleted>(events.cm.review.restored, { data: doc });
