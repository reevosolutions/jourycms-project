...
export default class DevService extends BaseService {
  ...
  public testAmqp() {
    ...
    amqpManager.publishEvent(events.amqp.test, payload);
  ...
  public triggerCreatedEvent() {
    const doc: any = {};
    this.eventDispatcher.dispatch<Levelup.V2.Events.Payloads.Accounts.Company.created>(
      events.accounts.company.created,
      { data: doc }
    );
  }
