...
import EntityAlias = Levelup.V2.Cm.Entity.Article;
import ApiAlias = Levelup.V2.Cm.Api.Articles;
import DocumentAlias = Levelup.V2.Cm.Model.ArticleDocument;
import EventPayloadsAlias = Levelup.V2.Events.Payloads.Cm.Article;
  ...
  */
  ...
  public async create(
    ...
    try {
      ...
      this.eventDispatcher.dispatch<EventPayloadsAlias.created>(events.cm.article.created, { data: doc });
  ...
  */
  public async update(
    ...
    try {
       ...
       */
      this.eventDispatcher.dispatch<EventPayloadsAlias.updated>(events.cm.article.updated, { data: doc });
  ...
  */
  public async delete(
    ...
    try {
      ...
      this.eventDispatcher.dispatch<EventPayloadsAlias.deleted>(events.cm.article.deleted, { data: doc });
  ...
  */
  public async restore(
    ...
    try {
      ...
      this.eventDispatcher.dispatch<EventPayloadsAlias.deleted>(events.cm.article.restored, { data: doc });
