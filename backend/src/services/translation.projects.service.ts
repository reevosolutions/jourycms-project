...
import TranslationProjectValidators from '../utils/validators/translation.project.validators';
import TranslationProjectSanitizers from '../utils/sanitizers/translation.project.sanitizers';
...
import EntityAlias = Levelup.V2.Cm.Translation.Entity.Project;
import ApiAlias = Levelup.V2.Cm.Translation.Api.Projects;
import DocumentAlias = Levelup.V2.Cm.Translation.Model.ProjectDocument;
import EventPayloadsAlias = Levelup.V2.Events.Payloads.Cm.Translation.Project;
  ...
  */
  ...
  public async create(
    ...
    try {
      ...
      this.eventDispatcher.dispatch<EventPayloadsAlias.created>(events.cm.translation.project.created, { data: doc });
  ...
  */
  public async update(
    ...
    try {
       ...
       */
      this.eventDispatcher.dispatch<EventPayloadsAlias.updated>(events.cm.translation.project.updated, { data: doc });
  ...
  */
  public async delete(
    ...
    try {
      ...
      this.eventDispatcher.dispatch<EventPayloadsAlias.deleted>(events.cm.translation.project.deleted, { data: doc });
  ...
  */
  public async restore(
    ...
    try {
      ...
      this.eventDispatcher.dispatch<EventPayloadsAlias.deleted>(events.cm.translation.project.restored, { data: doc });
...
export const levelupExportServicePermissions: Levelup.V2.SystemStructure.ExportServicePermissions<TLevelupExportServicePermissionsGroups> = () => ({
  ...
  PERMISSIONS: {
    "translation projects": [
      ...
      'update own translation project',
      'update any translation project',
      'delete own translation project',
      'delete any translation project',
      'view own translation projects',
