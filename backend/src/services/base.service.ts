...
import LevelupSdk from "@levelup-system/sdk";
import say from "say";
...
export default class BaseService {
  ...
  public logError(
    ...
    authData?: Levelup.V2.Security.AuthData | null,
    related_to?: string,
    scenario?: any
  ): void {
  ...
  public async logExecutionResult(
    method: Function,
    result: any,
    auth_data?: Levelup.V2.Security.AuthData,
    scenario?: any,
  ...
  public get internalAuthData(): {
    current: {
      service: {
        name: Levelup.V2.SystemStructure.TMicroservice;
        is_external: boolean;
      };
    };
  } {
  ...
  public generateSdkRequestConfigFromAuthData(
  ...
  ): Levelup.V2.SDK.TRequestConfig | undefined {
    ...
    const config: Levelup.V2.SDK.TRequestConfig = {
      token,
...
> implements Levelup.V2.SystemStructure.ExecutionScenario<T>
{
  public _class: string;
  public method: string;
  public args: Record<string, any>;
  public authData: Levelup.V2.Security.AuthData;
  ...
  public constructor(
    ...
    authData: Levelup.V2.Security.AuthData | null = null
  ) {
    this._class = _class;
    this.logger = logger;
    this.method = method;
