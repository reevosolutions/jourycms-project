...
import ApiAlias = Levelup.V2.Cm.Translation.Api.Tools;
...
export default class TranslationToolsService extends BaseService {
  ...
  private _CACHE: {
    projects: {
      [Name: string]: {
        project: Levelup.V2.Cm.Translation.Entity.Project;
        namespaces: {
          [Name: string]: {
            namespace: Levelup.V2.Cm.Translation.Entity.Namespace;
            items: {
              [Hash: string]: true;
            };
          };
  ...
  private async saveProjectToCache(project: Levelup.V2.Cm.Translation.Entity.Project) {
    try {
  ...
  private async loadNamespace(project: Levelup.V2.Cm.Translation.Entity.Project, name: string) {
    try {
      // load from cache
  ...
  public async insertI18MissingKey(
    ...
    try {
      ...
      const objects: {
        project?: Levelup.V2.Cm.Translation.Entity.Project;
        namespace?: Levelup.V2.Cm.Translation.Entity.Namespace;
        item?: Levelup.V2.Cm.Translation.Entity.Item;
      } = {};
      /**
      ...
      if (!objects.project) {
        ...
        const body: Levelup.V2.Cm.Translation.Api.Projects.Create.Request = {
          data: {
      ...
      if (!objects.namespace) {
        ...
        const body: Levelup.V2.Cm.Translation.Api.Namespaces.Create.Request = {
          data: {
      ...
      if (!itemFound) {
        ...
        const body: Levelup.V2.Cm.Translation.Api.Items.Create.Request = {
          data: {
            app: objects.project.app,
            project: objects.project._id,
  ...
  public async translateUsingGoogleAPI(authData: Levelup.V2.Security.AuthData = {}) {
    try {
      const translationItemsService = Container.get(TranslationItemsService);
