 ...
 */
export default class OfficesCacheManager
  implements Levelup.V2.CacheManager.EntityCacheManager<"office">
{
  private logger: LoggerService;

  private static instance: OfficesCacheManager;
  private readonly cache: CacheManager;

  private readonly EXPIRATION = 3600 * 48;
  private readonly ENTITY = "office" as const;
  ...
  public static getInstance(): OfficesCacheManager {
  ...
  public async list(
    config: {
      company?: string | null;
      query?: Levelup.V2.CacheManager.TListQueryParams<"office">;
      force_load_from_db?: boolean;
      filter?: (
        item: Levelup.V2.SystemStructure.EntityType<"office">
      ) => boolean;
    } = {
      query: {} as any,
      force_load_from_db: true,
    }
  ): Promise<Levelup.V2.SystemStructure.EntityType<"office">[]> {
    return this.cache.list(this.ENTITY, config);
  }

  public async set(
    id: string,
    value: Partial<Levelup.V2.SystemStructure.EntityType<"office">>,
    company?: string | null
  ) {
