...
import DocumentAlias = Levelup.CMS.V1.Content.Model.TermDocument;
import EventPayloadsAlias = Levelup.CMS.V1.Events.Payloads.Content.Term;
...
export default class TermsService extends BaseService {
  ...
  public async create(
    ...
    try {
      ...
      this.eventDispatcher.dispatch<EventPayloadsAlias.created>(events.content.term.created, { data: doc });
  ...
  public async update(
    ...
    try {
       ...
       */
      this.eventDispatcher.dispatch<EventPayloadsAlias.updated>(events.content.term.updated, { data: doc });
  ...
  public async delete(id: string, authData: Levelup.CMS.V1.Security.AuthData): Promise<ApiAlias.Delete.Response> {
    try {
      ...
      this.eventDispatcher.dispatch<EventPayloadsAlias.deleted>(events.content.term.deleted, { data: doc });
  ...
  public async restore(id: string, authData: Levelup.CMS.V1.Security.AuthData): Promise<ApiAlias.Delete.Response> {
    try {
      ...
      this.eventDispatcher.dispatch<EventPayloadsAlias.deleted>(events.content.term.restored, { data: doc });
