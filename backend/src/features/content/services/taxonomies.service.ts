...
import DocumentAlias = Levelup.CMS.V1.Content.Model.TaxonomyDocument;
import EventPayloadsAlias = Levelup.CMS.V1.Events.Payloads.Content.Taxonomy;
  ...
  */
  ...
  public async create(
    ...
    try {
      ...
      this.eventDispatcher.dispatch<EventPayloadsAlias.created>(events.content.taxonomy.created, { data: doc });
  ...
  */
  public async update(
    ...
    try {
       ...
       */
      this.eventDispatcher.dispatch<EventPayloadsAlias.updated>(events.content.taxonomy.updated, { data: doc });
  ...
  */
  public async delete(
    ...
    try {
      ...
      this.eventDispatcher.dispatch<EventPayloadsAlias.deleted>(events.content.taxonomy.deleted, { data: doc });
  ...
  */
  public async restore(
    ...
    try {
      ...
      this.eventDispatcher.dispatch<EventPayloadsAlias.deleted>(events.content.taxonomy.restored, { data: doc });
