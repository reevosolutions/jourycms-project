...
import DocumentAlias = Levelup.CMS.V1.Content.Translation.Model.ItemDocument;
import EventPayloadsAlias = Levelup.CMS.V1.Events.Payloads.Content.Translation.Item;
...
export default class TranslationItemsService extends BaseService {
  ...
  public async create(
    ...
    try {
      ...
      this.eventDispatcher.dispatch<EventPayloadsAlias.created>(events.content.translation.item.created, { data: doc });
    ...
    try {
      ...
      if (data.translation_updates) {
        ...
        Object.keys(data.translation_updates).forEach(l => {
          const lang = l as Levelup.CMS.V1.Content.Translation.Entity.TLanguageCode;
       ...
       */
      this.eventDispatcher.dispatch<EventPayloadsAlias.updated>(events.content.translation.item.updated, { data: doc });
  ...
  public async delete(id: string, authData: Levelup.CMS.V1.Security.AuthData): Promise<ApiAlias.Delete.Response> {
    try {
      ...
      this.eventDispatcher.dispatch<EventPayloadsAlias.deleted>(events.content.translation.item.deleted, { data: doc });
  ...
  public async restore(id: string, authData: Levelup.CMS.V1.Security.AuthData): Promise<ApiAlias.Delete.Response> {
    try {
      ...
      this.eventDispatcher.dispatch<EventPayloadsAlias.deleted>(events.content.translation.item.restored, { data: doc });
  ...
  public async translate(
    id: string,
    lang: Levelup.CMS.V1.Content.Translation.Entity.TLanguageCode,
    value: string,
