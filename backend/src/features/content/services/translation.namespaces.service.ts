...
import DocumentAlias = Levelup.CMS.V1.Content.Translation.Model.NamespaceDocument;
import EventPayloadsAlias = Levelup.CMS.V1.Events.Payloads.Content.Translation.Namespace;
  ...
  */
  ...
  public async create(
    ...
    try {
      ...
      this.eventDispatcher.dispatch<EventPayloadsAlias.created>(events.content.translation.namespace.created, { data: doc });
  ...
  */
  public async update(
    ...
    try {
       ...
       */
      this.eventDispatcher.dispatch<EventPayloadsAlias.updated>(events.content.translation.namespace.updated, { data: doc });
  ...
  */
  public async delete(
    ...
    try {
      ...
      this.eventDispatcher.dispatch<EventPayloadsAlias.deleted>(events.content.translation.namespace.deleted, { data: doc });
  ...
  */
  public async restore(
    ...
    try {
      ...
      this.eventDispatcher.dispatch<EventPayloadsAlias.deleted>(events.content.translation.namespace.restored, { data: doc });
