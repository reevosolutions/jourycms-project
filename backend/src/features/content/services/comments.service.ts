...
import DocumentAlias = Levelup.CMS.V1.Content.Model.CommentDocument;
import EventPayloadsAlias = Levelup.CMS.V1.Events.Payloads.Content.Comment;
  ...
  */
  ...
  public async create(
    ...
    try {
      ...
      this.eventDispatcher.dispatch<EventPayloadsAlias.created>(events.content.comment.created, { data: doc });
  ...
  */
  public async update(
    ...
    try {
       ...
       */
      this.eventDispatcher.dispatch<EventPayloadsAlias.updated>(events.content.comment.updated, { data: doc });
  ...
  */
  public async delete(
    ...
    try {
      ...
      this.eventDispatcher.dispatch<EventPayloadsAlias.deleted>(events.content.comment.deleted, { data: doc });
  ...
  */
  public async restore(
    ...
    try {
      ...
      this.eventDispatcher.dispatch<EventPayloadsAlias.deleted>(events.content.comment.restored, { data: doc });
