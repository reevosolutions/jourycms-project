 ...
 * @description This file is used to create "Form" sanitizer.
 */
...
/**
 * @description
 * @param {Levelup.CMS.V1.Content.Api.Forms.Create.Request['data']} body
 * @returns {Levelup.CMS.V1.Content.Api.Forms.Create.Request['data']}
 */
...
/**
 * @description
 * @param {Levelup.CMS.V1.Content.Api.Forms.Update.Request['data']} body
 * @returns {Levelup.CMS.V1.Content.Api.Forms.Update.Request['data']}
 */
 ...
 * @generator Levelup
 */
const FormSanitizers = {
  sanitizeCreateBody,
  sanitizeUpdateBody
};
export default FormSanitizers;
