 ...
 * @returns {Levelup.CMS.V1.Content.Translation.Api.Namespaces.Create.Request['data']}
 */
 ...
 * @returns {Levelup.CMS.V1.Content.Translation.Api.Namespaces.Update.Request['data']}
 */
