 ...
 * @description This file is used to create "Article" sanitizer.
 */
 ...
 * @returns {Levelup.CMS.V1.Content.Api.Articles.Create.Request['data']}
 */
 ...
 * @returns {Levelup.CMS.V1.Content.Api.Articles.Update.Request['data']}
 */
 ...
 * @generator Levelup
 */
const ArticleSanitizers = {
  sanitizeCreateBody,
  sanitizeUpdateBody
};
export default ArticleSanitizers;
