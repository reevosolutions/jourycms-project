 ...
 * @description This file is used to create "FormEntry" validators.
 */
import Joi from "joi";
 ...
 * @returns {Joi.ValidationResult<Levelup.CMS.V1.Content.Api.FormEntries.Create.Request['data']>}
 */
 ...
 * @returns {Joi.ValidationResult<Levelup.CMS.V1.Content.Api.FormEntries.Update.Request['data']>}
 */
 ...
 * @generator Levelup
 */
const FormEntryValidators = {
  validateCreateBody,
  validateUpdateBody
};
export default FormEntryValidators;
