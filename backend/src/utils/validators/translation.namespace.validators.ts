 ...
 * @returns {Joi.ValidationResult<Levelup.V2.Cm.Translation.Api.Namespaces.Create.Request['data']>}
 */
 ...
 * @returns {Joi.ValidationResult<Levelup.V2.Cm.Translation.Api.Namespaces.Update.Request['data']>}
 */
