 ...
 * @returns {Joi.ValidationResult<Levelup.V2.Cm.Api.Taxonomies.Create.Request['data']>}
 */
 ...
 * @returns {Joi.ValidationResult<Levelup.V2.Cm.Api.Taxonomies.Update.Request['data']>}
 */
...
export default TaxonomyValidators;
