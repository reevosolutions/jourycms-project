 ...
 * @description This file is used to create "Comment" sanitizer.
 */
...
/**
 * @description
 * @param {Levelup.V2.Cm.Api.Comments.Create.Request['data']} body
 * @returns {Levelup.V2.Cm.Api.Comments.Create.Request['data']}
 */
...
/**
 * @description
 * @param {Levelup.V2.Cm.Api.Comments.Update.Request['data']} body
 * @returns {Levelup.V2.Cm.Api.Comments.Update.Request['data']}
 */
 ...
 * @generator Levelup
 */
const CommentSanitizers = {
  sanitizeCreateBody,
  sanitizeUpdateBody
};
export default CommentSanitizers;
