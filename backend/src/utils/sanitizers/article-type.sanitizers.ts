 ...
 * @description This file is used to create "ArticleType" sanitizer.
 */
 ...
 * @returns {Levelup.V2.Cm.Api.ArticleTypes.Create.Request['data']}
 */
 ...
 * @returns {Levelup.V2.Cm.Api.ArticleTypes.Update.Request['data']}
 */
...
export default ArticleTypeSanitizers;
