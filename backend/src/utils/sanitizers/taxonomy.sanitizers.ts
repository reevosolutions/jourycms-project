 ...
 * @description This file is used to create "Taxonomy" sanitizer.
 */
...
/**
 * @description
 * @param {Levelup.V2.Cm.Api.Taxonomies.Create.Request['data']} body
 * @returns {Levelup.V2.Cm.Api.Taxonomies.Create.Request['data']}
 */
...
/**
 * @description
 * @param {Levelup.V2.Cm.Api.Taxonomies.Update.Request['data']} body
 * @returns {Levelup.V2.Cm.Api.Taxonomies.Update.Request['data']}
 */
 ...
 * @generator Levelup
 */
const TaxonomySanitizers = {
  sanitizeCreateBody,
  sanitizeUpdateBody
};
export default TaxonomySanitizers;
