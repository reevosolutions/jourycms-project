 ...
 * @description This file is used to create "Namespace" sanitizer.
 */
...
/**
 * @description
 * @param {Levelup.V2.Cm.Translation.Api.Namespaces.Create.Request['data']} body
 * @returns {Levelup.V2.Cm.Translation.Api.Namespaces.Create.Request['data']}
 */
...
/**
 * @description
 * @param {Levelup.V2.Cm.Translation.Api.Namespaces.Update.Request['data']} body
 * @returns {Levelup.V2.Cm.Translation.Api.Namespaces.Update.Request['data']}
 */
 ...
 * @generator Levelup
 */
const TranslationNamespaceSanitizers = {
  sanitizeCreateBody,
  sanitizeUpdateBody
};
export default TranslationNamespaceSanitizers;
