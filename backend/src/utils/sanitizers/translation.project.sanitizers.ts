 ...
 * @description This file is used to create "Project" sanitizer.
 */
 ...
 * @returns {Levelup.V2.Cm.Translation.Api.Projects.Create.Request['data']}
 */
 ...
 * @returns {Levelup.V2.Cm.Translation.Api.Projects.Update.Request['data']}
 */
 ...
 * @generator Levelup
 */
const TranslationProjectSanitizers = {
  sanitizeCreateBody,
  sanitizeUpdateBody
};
export default TranslationProjectSanitizers;
