...
export default class TagSubscriber {
  ...
  public async onTagCreated({data}: Levelup.CMS.V1.Events.Payloads.Content.Term.created): Promise < void> {
  ...
  public async onTagUpdated({data}: Levelup.CMS.V1.Events.Payloads.Content.Term.updated): Promise < void> {
  ...
  public async onTagDeleted({data}: Levelup.CMS.V1.Events.Payloads.Content.Term.deleted): Promise < void> {
  ...
  public async onTagRestored({data}: Levelup.CMS.V1.Events.Payloads.Content.Term.restored): Promise < void> {
