 ...
 */
type _Entity = Levelup.V2.Cm.Translation.Entity.Item;
type _Model = Levelup.V2.Cm.Translation.Model.Item;
type _Document = Levelup.V2.Cm.Translation.Model.ItemDocument;
