 ...
 */
type _Entity = Levelup.V2.Cm.Translation.Entity.Namespace;
type _Model = Levelup.V2.Cm.Translation.Model.Namespace;
type _Document = Levelup.V2.Cm.Translation.Model.NamespaceDocument;
