export const SHIPMENT_TO: Levelup.V2.Shipping.Entity.TShipmentTo[] = [
  "home",
  "desk",
];
export const SHIPMENT_FROM: Levelup.V2.Shipping.Entity.TShipmentFrom[] = [
  "office",
  "warehouse",
];
...
export const SHIPMENT_TYPES: Levelup.V2.Shipping.Entity.TShipmentType[] = [
  "express",
  "economic",
  "freight",
];
export const PARCEL_TYPES: Levelup.V2.Shipping.Entity.TParcelType[] = [
  "classic",
  "ecommerce",
  "internal",
  "b2b",
];
export const PARCEL_SUB_TYPES: Levelup.V2.Shipping.Entity.TParcelSubType[] = [
  "normal",
  "with_exchange",
  "exchange",
...
export const PAYMENT_STATUSES: Levelup.V2.Payment.Entity.TParcelPaymentStatus[] =
  ["not_initialized", "not_ready", "ready", "receivable", "paid"];
export const PARCEL_PLACE_STATUSES: Levelup.V2.Shipping.Entity.TParcelPlaceStatus[] =
  ["in_office", "at_seller", "on_the_way", "out_in_delivery"];
...
PARCEL_STATUSES_GROUPED.return = [
  ...PARCEL_STATUSES_GROUPED.returning,
  ...PARCEL_STATUSES_GROUPED.returned,
];
...
Object.keys(PARCEL_STATUSES_GROUPED).forEach((group) => {
  PARCEL_STATUSES_GROUPED[
    group as Levelup.V2.Shipping.Entity.TParcelStatusGroup
  ].forEach(
    (status) =>
      (PARCEL_STATUS_GROUPS[status] = [
        ...(PARCEL_STATUS_GROUPS[status] || []),
        group as Levelup.V2.Shipping.Entity.TParcelStatusGroup,
      ])
  );
...
export const UPDATABLE_PARCEL_STATUSES: Levelup.V2.Shipping.Entity.TParcelStatus[] =
  ["_not_shipped_yet", "in_preparation", "ready_to_ship"];
...
export const PARCEL_STATUSES_RETURNED_FINAL: Levelup.V2.Shipping.Entity.TParcelStatus[] =
  ["returned_to_seller", "returned_to_warehouse"];
...
export const PARCEL_STATUSES_AT_SELLER: Levelup.V2.Shipping.Entity.TParcelStatus[] =
  ["_not_shipped_yet", "_not_yet_picked_up", "in_preparation", "ready_to_ship"];
...
export const INITIAL_ACKNOWLEDGMENT_STATUS: Levelup.V2.Shipping.Entity.TParcelStatus =
  "_not_yet_picked_up";
export const ACKNOWLEDGMENT_STATUS_AFTER_PICKUP_BY_DELIVERER: Levelup.V2.Shipping.Entity.TParcelStatus =
  "picked_up";
export const INITIAL_EXCHANGE_STATUS: Levelup.V2.Shipping.Entity.TParcelStatus =
  "_not_yet_picked_up";
export const EXCHANGE_STATUS_AFTER_PICKUP_BY_DELIVERER: Levelup.V2.Shipping.Entity.TParcelStatus =
  "picked_up";
...
export const PARCEL_STATUS_HISTORY: {
  [oldStatus in Levelup.V2.Shipping.Entity.TParcelStatus]: (
    | Levelup.V2.Shipping.Entity.TParcelStatus
    | "*"
  )[];
} = {
...
export const getOldParcelStatus: (
  new_status: Levelup.V2.Shipping.Entity.TParcelStatus
) => Levelup.V2.Shipping.Entity.TParcelStatus[] = (new_status) => {
  ...
  Object.keys(PARCEL_STATUS_HISTORY).forEach((status) => {
    if (
      PARCEL_STATUS_HISTORY[
        status as Levelup.V2.Shipping.Entity.TParcelStatus
      ].includes(new_status) ||
      PARCEL_STATUS_HISTORY[
        status as Levelup.V2.Shipping.Entity.TParcelStatus
      ].includes("*")
...
export const parcelCanPassToStatus: (
  old_status: Levelup.V2.Shipping.Entity.TParcelStatus,
  new_status: Levelup.V2.Shipping.Entity.TParcelStatus
) => boolean = (old_status, new_status) => {
  const old_probable_statuses: Levelup.V2.Shipping.Entity.TParcelStatus[] =
    getOldParcelStatus(new_status);
