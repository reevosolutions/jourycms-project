export const ticketStatuses: Levelup.V2.Support.Entity.TTicketStatus[] = [
  "new",
  "open",
  "rejected",
  "closed",
...
export const ticketResponseStatuses: Levelup.V2.Support.Entity.TTicketResponseStatus[] =
  ["new", "open", "closed"];
...
export const TICKET_PREDEFINED_TYPES = {
  ...
  "Technical Support": {
    ...
    service: null,
    description:
      "Technical issues related to the platform, including bugs and system downtimes.",
    request_fields: [],
    children: [
      {
        ...
        description:
          "Problems related to the platform's technical aspects, such as bugs or system downtimes.",
        request_fields: [],
      },
      {
        name: "User Support",
        ...
        description:
          "Queries regarding how to use the system, feature requests, or user account issues.",
        request_fields: [],
      },
    ],
  },
  "Billing and Payments": {
    ...
    service: null,
    description:
      "Issues related to invoicing, payment discrepancies, or refunds.",
    request_fields: [],
    children: [],
  },
  "Account Management": {
    ...
    service: null,
    description:
      "User support for account-related queries and feature requests.",
    request_fields: [],
    children: [],
  },
  sourcing: {
    ...
    children: [
      {
        ...
        description:
          "Challenges related to suppliers, including delays or product quality concerns.",
        request_fields: [],
      },
      {
        ...
        description:
          "Inquiries about sourcing specific products or new product additions.",
        request_fields: [],
      },
    ],
  },
  delivery: {
    ...
    service: "delivery",
    description:
      "Parcel and order management, including status changes and updates.",
    request_fields: [],
    children: [
      {
        ...
        description:
          "Requests to update the status of a parcel, with mandatory parcel identification.",
      ...
      },
      {
        ...
        description:
          "Requests to change the price of a parcel, potentially affecting shipping costs.",
        mandatory_attribute: "parcel",
        request_fields: [
          {
            field_type: "number",
      ...
      },
      {
        ...
        description:
          "Requests to update customer phone numbers associated with a parcel.",
        mandatory_attribute: "parcel",
        request_fields: [
          {
            field_type: "phones",
      ...
      },
      {
        ...
        description:
          "Requests to update the city of the destination address for a parcel.",
        mandatory_attribute: "parcel",
        request_fields: [
          {
            field_type: "delivery_city",
      ...
      },
      {
        ...
        description:
          "Requests for authorization to open a parcel before delivery.",
        mandatory_attribute: "parcel",
        request_fields: [
          {
            field_type: "boolean",
  ...
  callcenter: {
    ...
    service: "callcenter",
    description:
      "Call handling and information requests managed by the call center.",
    request_fields: [],
    children: [
      {
      ...
      },
      {
        ...
        description:
          "Issues related to the handling of calls, including feedback on customer service quality.",
        mandatory_attribute: "order",
        request_fields: [],
      },
      {
        ...
        description:
          "Requests for information typically handled over calls, possibly needing detailed follow-up.",
        mandatory_attribute: "order",
        request_fields: [],
      },
    ],
  ...
  warehouse: {
    ...
    description:
      "Inventory tracking and warehouse safety and compliance issues.",
    service: "warehouse",
    request_fields: [],
    children: [
      {
        ...
        description:
          "Issues related to stock levels, misplacements, or system errors in inventory tracking.",
      ...
      },
      {
        ...
        description:
          "Concerns regarding warehouse safety or regulatory compliance.",
        mandatory_attribute: "inentory_item",
        request_fields: [],
      },
    ],
  ...
  dropshipping: {
    ...
    description:
      "Partner coordination and product integration for dropshipping.",
    request_fields: [],
    children: [
      {
        ...
        description:
          "Problems with dropshipping partners, such as compliance with terms or coordination errors.",
        request_fields: [],
      },
      {
        ...
        description:
          "Challenges related to integrating new products from dropshippers into the marketplace.",
        request_fields: [],
      },
    ],
  },
  store_management: {
    ...
    description:
      "Operational issues and policy management for the online store.",
    request_fields: [],
    children: [
      {
        ...
        description:
          "Operational challenges in managing the online store, such as configuration issues or performance optimizations.",
        request_fields: [],
      },
      {
        name: "Store Policy",
        ...
        description:
          "Inquiries or issues related to store policies, returns, or customer disputes.",
        request_fields: [],
      },
    ],
  },
  marketplace: {
    ...
    service: "marketplace",
    description:
      "Support for sellers and handling of buyer complaints in the marketplace.",
    request_fields: [],
    children: [
      {
        name: "Seller Support",
        ...
        description:
          "Assistance for sellers on the marketplace, including listing problems or dispute resolution.",
        request_fields: [],
      },
      {
        ...
        description:
          "Handling complaints from buyers about sellers or products on the marketplace.",
        request_fields: [],
      },
    ],
  },
  "Advanced Issues": {
    ...
    description:
      "Security concerns, fraud, and requests for new features or enhancements.",
    service: null,
    request_fields: [],
    children: [
      {
        ...
        description:
          "Concerns about security breaches, fraudulent activities, or abuse of the system.",
        request_fields: [],
      },
      {
        ...
        description:
          "Suggestions for new features or improvements to existing features.",
        request_fields: [],
      },
    ],
  },
