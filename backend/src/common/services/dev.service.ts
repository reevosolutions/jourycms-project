...
type CustomField<T extends Levelup.CMS.V1.Content.CustomFields.CustomFieldType> = Levelup.CMS.V1.Content.CustomFields.MetaField<T>;
...
`
  ...
  async fillAgencies() {
    for (const state of faker.helpers.arrayElements(states, 58)) {
      const stateCities = cities.filter(item => item.state_code === state.code);
      for (const index of new Array(faker.number.int({ min: 1, max: 10 })).fill(null)) {
        try {
          const city = faker.helpers.arrayElement(stateCities);
          const data: RegisterPayload = {
            email: faker.internet.email(),
  ...
  async fillAiroports() {
    ...
    if (user) {
      const dzCount = await this.articleModel.countDocuments({ 'meta_fields.country': 'dz', article_type: this.types[ArticleTypeSlug.AIROPORT]?._id });
      ...
      const ksaCount = await this.articleModel.countDocuments({ 'meta_fields.country': 'ksa', article_type: this.types[ArticleTypeSlug.AIROPORT]?._id });
      if (!ksaCount)
  ...
  async fillShrines() {
    const shrines = [
      {
        ...
        "description": "<p>المسجد الحرام هو أكبر وأقدس مسجد في الإسلام، ويقع في قلب مكة المكرمة. يحيط المسجد بالكعبة، وهو أول بيت وضع للناس على الأرض لعبادة الله. المسجد الحرام يشهد تجمع ملايين المسلمين سنويًا لأداء الحج والعمرة، ويحتوي على عدة مواقع مقدسة مثل <strong>الكعبة</strong>، <strong>مقام إبراهيم</strong>، و <strong>الحجر الأسود</strong>.</p>"
      },
      {
        "name": "الكعبة",
        "makkah_medina": "mekkah",
        "description": "<p>الكعبة هي هيكل مكعب الشكل يقع في وسط المسجد الحرام، ويعتبر قبلة المسلمين في صلاتهم. يعتقد أن إبراهيم وابنه إسماعيل هما من رفعا قواعد الكعبة. تحتوي الكعبة على <strong>الحجر الأسود</strong>، وهو حجر مبارك يمسحه المسلمون عند الطواف إن استطاعوا. يعتبر الطواف حول الكعبة سبعة أشواط من أهم مناسك الحج والعمرة.</p>"
      },
      {
        "name": "مقام إبراهيم",
        "makkah_medina": "mekkah",
        "description": "<p>مقام إبراهيم هو حجر أثري يقع بالقرب من الكعبة في المسجد الحرام، يُعتقد أن إبراهيم عليه السلام وقف عليه أثناء بناء الكعبة. يحتوي الحجر على أثر قدمي النبي إبراهيم. يصلي المسلمون ركعتين خلف المقام بعد الطواف حول الكعبة، اقتداءً بسنة النبي محمد صلى الله عليه وسلم.</p>"
      },
      {
        "name": "الحجر الأسود",
        "makkah_medina": "mekkah",
        "description": "<p>الحجر الأسود هو حجر يقع في أحد أركان الكعبة، ويعتبر من أقدس الأحجار في الإسلام. يعتقد المسلمون أنه نزل من الجنة، وهو يلمس أو يُقبل عند الطواف حول الكعبة إن أمكن. يعد الحجر الأسود بداية الطواف ونهايته، ويُعتبر رمزًا للوحدة بين المسلمين.</p>"
      },
      {
        "name": "الصفا والمروة",
        "makkah_medina": "mekkah",
        "description": "<p>الصفا والمروة هما جبلان صغيران يقعان بالقرب من الكعبة. يُعد السعي بينهما جزءًا من مناسك الحج والعمرة، وهو تذكار لسعي السيدة هاجر بحثًا عن الماء لابنها إسماعيل. يقوم المسلمون بالسعي سبعة أشواط بين الجبلين كرمز للتوكل على الله وتلبية احتياجاتهم.</p>"
      },
      {
        "name": "بئر زمزم",
        "makkah_medina": "mekkah",
        "description": "<p>بئر زمزم هو بئر مقدس يقع في المسجد الحرام، يُعتقد أنه تفجر بفضل الله كمعجزة لتوفير الماء للسيدة هاجر وابنها إسماعيل. يُعتبر ماء زمزم مقدسًا ويشربه الحجاج والمعتمرون بنية التبرك وطلب الشفاء. يُذكر أن ماء زمزم لا ينضب رغم توافد الملايين من المسلمين عليه على مر العصور.</p>"
      },
      {
        "name": "جبل عرفات",
        "makkah_medina": "mekkah",
        "description": "<p>جبل عرفات هو موقع مقدس يقع خارج حدود مكة، حيث يقف الحجاج في التاسع من ذي الحجة من كل عام للدعاء والتضرع إلى الله. يُعتبر الوقوف بعرفات من أعظم أركان الحج، ويقال إنه المكان الذي التقى فيه آدم وحواء بعد نزولهما إلى الأرض. يشهد يوم عرفة تجمعًا مهيبًا للمسلمين من كل أنحاء العالم للدعاء والاستغفار.</p>"
      },
      {
        "name": "منى",
        "makkah_medina": "mekkah",
        "description": "<p>منى هي منطقة تقع بالقرب من مكة المكرمة، ويقضي فيها الحجاج معظم أيام الحج. تشتهر بوجود الجمرات، حيث يقوم الحجاج برمي الجمرات كرمز لرجم الشيطان. وتعد هذه المنطقة من أهم محطات مناسك الحج، ويؤدي فيها الحجاج عدة مناسك مثل <strong>المبيت في منى</strong> ورمي الجمرات خلال أيام التشريق.</p>"
      },
      {
        "name": "المسجد النبوي",
        "makkah_medina": "medina",
        "description": "<p>المسجد النبوي هو ثاني أقدس مسجد في الإسلام، ويقع في المدينة المنورة. أسسه النبي محمد صلى الله عليه وسلم، ويحتوي على قبره وقبري صاحبيه أبي بكر الصديق وعمر بن الخطاب. يتميز المسجد النبوي بمكانة عظيمة لدى المسلمين، ويقصدونه للصلاة والتبرك بزيارة الروضة الشريفة التي يُقال إنها روضة من رياض الجنة.</p>"
      },
      {
        "name": "الروضة الشريفة",
        "makkah_medina": "medina",
        "description": "<p>الروضة الشريفة هي مساحة محددة داخل المسجد النبوي بين منبر النبي وقبره، ويعتبرها المسلمون جزءًا من الجنة. تعد زيارة الروضة الشريفة من الأعمال المحببة، حيث يجلس المسلمون فيها للدعاء والصلاة، ويعتقدون أنها مكان مبارك ذو فضل عظيم.</p>"
      },
      {
        "name": "قبر النبي محمد",
        "makkah_medina": "medina",
        "description": "<p>قبر النبي محمد صلى الله عليه وسلم يقع في الحجرة الشريفة داخل المسجد النبوي. يُعد زيارة قبر النبي من الأعمال التي يقوم بها المسلمون أثناء زيارتهم للمدينة المنورة، ويعتبرونه مكانًا مباركًا يذكرهم بسيرة النبي وأخلاقه. يُدفن بجانب النبي كل من أبي بكر الصديق وعمر بن الخطاب رضي الله عنهما.</p>"
      }
    ];
    ...
    const count = await this.articleModel.countDocuments({ article_type: this.types[ArticleTypeSlug.SHRINE]?._id });
    if (!count)
  ...
  async fillHotels() {
    ...
    if (user) {
      const count = await this.articleModel.countDocuments({ article_type: this.types[ArticleTypeSlug.HOTEL]?._id });
      if (!count)
  ...
  async fillTrips() {
    ...
    if (user) {
      ...
      const { data: ksaAiroports } = await this.articlesService.list({
        count: 200,
        filters: { article_type: this.types[ArticleTypeSlug.AIROPORT]?._id, 'meta_fields.country': 'ksa' }
      }, this.internalAuthData);
      ...
      const trip_durations = (this.types[ArticleTypeSlug.OMRAH]?.custom_meta_fields.find(f => f.field_key === 'trip_duration') as CustomField<'select'>)?.field_options.choices.map(c => c.value);
      const trip_types = (this.types[ArticleTypeSlug.OMRAH]?.custom_meta_fields.find(f => f.field_key === 'trip_type') as CustomField<'select'>)?.field_options.choices.map(c => c.value);
      const subsistence_at_mekkah = (this.types[ArticleTypeSlug.OMRAH]?.custom_meta_fields.find(f => f.field_key === 'subsistence_at_mekkah') as CustomField<'select'>)?.field_options.choices.map(c => c.value);
      const subsistence_at_medina = (this.types[ArticleTypeSlug.OMRAH]?.custom_meta_fields.find(f => f.field_key === 'subsistence_at_medina') as CustomField<'select'>)?.field_options.choices.map(c => c.value);
      const medina_mekkah = (this.types[ArticleTypeSlug.OMRAH]?.custom_meta_fields.find(f => f.field_key === 'medina_mekkah') as CustomField<'select'>)?.field_options.choices.map(c => c.value) || ['medina', 'mekkah'];
      ...
      for (let index = 0; index < 500; index++) {
        ...
        const { data: owner } = await this.usersService.getById(agency.created_by, this.internalAuthData);
        ...
        if (owner) {
          ...
          const article: Article = {
            ...
            meta_fields: {
              ...
              airelines_company: faker.helpers.arrayElement(airlinesCompanies)?._id,
              ...
              shrines_at_mekkah: faker.helpers.arrayElements(shrines.filter(i => i.meta_fields['medina_mekkah'] === 'mekkah'), { min: 1, max: 5 })?.map(i => i._id),
              shrines_at_medina: faker.helpers.arrayElements(shrines.filter(i => i.meta_fields['medina_mekkah'] === 'medina'), { min: 1, max: 5 })?.map(i => i._id),
          ...
          await this.articlesService.create({ data: article }, { current: { user: owner } });
        }
