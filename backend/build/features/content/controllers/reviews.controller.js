...
const reviews_service_1 = __importDefault(require("../services/reviews.service"));
/**
 * @generator Levelup
 * @description This file is used to build the Reviews controller
 */
exports.ROOT_PATH = '/reviews';
exports.default = (app) => {
    const logger = (0, logging_1.default)("CONTROLLER", "ReviewsController");
    ...
    route.get('/', async (req, res, next) => {
        try {
             ...
             */
            const reviewsService = typedi_1.default.get(reviews_service_1.default);
            /**
