 ...
 */
exports.ROOT_PATH = '/comments';
exports.default = (app) => {
    const logger = (0, logging_1.default)("CONTROLLER", "CommentsController");
    ...
    route.get('/', async (req, res, next) => {
        try {
             ...
             */
            const commentsService = typedi_1.default.get(comments_service_1.default);
            /**
             * Call the service method if the validation conditions are fulfilled
             */
            const result = await commentsService.list(req.query, AUTH_DATA);
            /**
    ...
    route.post('/', async (req, res, next) => {
        try {
             ...
             * Call the service method if the validation conditions are fulfilled
             */
            const result = await commentsService.create(req.body, AUTH_DATA);
            /**
             * Respond to the client
             */
    ...
    route.put('/:id', async (req, res, next) => {
        try {
             ...
             */
            const { id } = req.params;
            const result = await commentsService.update(id, req.body, AUTH_DATA);
            /**
             * Respond to the client
             */
            return (0, requests_1.respond)(res, result);
