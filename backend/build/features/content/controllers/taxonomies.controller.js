...
const taxonomies_service_1 = __importDefault(require("../services/taxonomies.service"));
/**
 * @generator Levelup
 * @description This file is used to build the Taxonomies controller
 */
exports.ROOT_PATH = '/taxonomies';
exports.default = (app) => {
    const logger = (0, logging_1.default)("CONTROLLER", "TaxonomiesController");
    ...
    route.get('/', async (req, res, next) => {
        try {
             ...
             */
            const taxonomiesService = typedi_1.default.get(taxonomies_service_1.default);
            /**
