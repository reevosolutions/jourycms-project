 ...
 * @description
 */
let TranslationNamespacesService = class TranslationNamespacesService extends base_service_1.default {
    constructor(articleTypeModel, articleModel, commentModel, reviewModel, termModel, taxonomyModel, translationItemModel, translationNamespaceModel, translationProjectModel, eventDispatcher) {
        ...
        this.ENTITY = 'translationNamespace';
    }
    /**
    ...
    _applyFilters({ query, q, totalQ, opt, authData }) {
        ...
        // -- attributed:app
        if (translation_namespace_model_1.TranslationNamespaceSchemaFields['app']) {
        ...
        totalQ = filter.totalQ;
        // -- created_by
        if (translation_namespace_model_1.TranslationNamespaceSchemaFields['created_by']) {
    ...
    async list(query, authData, opt = {
        ...
        try {
            ...
            let q = this.translationNamespaceModel.find();
            let totalQ = this.translationNamespaceModel.where();
            /**
             * Apply filters
             */
    ...
    */
    ...
    async create({ data }, authData, opt) {
        ...
        try {
             ...
             */
            data = await translation_namespace_sanitizers_1.default.sanitizeCreateBody(data, authData);
            /**
             * Validate data here
             */
            const { error } = translation_namespace_validators_1.default.validateCreateBody(data);
            if (error)
                throw error;
            let {} = data;
            /**
             ...
             * Create tracking ID
             */
            if (translation_namespace_model_1.TranslationNamespaceSchemaFields['tracking_id'] && Object.keys(tracking_id_constants_1.ITEM_SHORTCUTS).includes(this.ENTITY)) {
                docObject['tracking_id'] = await (0, tracking_id_utilities_1.createTrackingId)(this.ENTITY, this.translationNamespaceModel);
            }
            /**
             * Create search meta
             */
            if (translation_namespace_model_1.TranslationNamespaceSchemaFields['search_meta']) {
            ...
            this.eventDispatcher.dispatch(events_config_1.default.content.translation.namespace.created, { data: doc });
            const result = {
                data: (0, general_mappers_1.mapDocumentToExposed)(doc)
            };
            /**
    ...
    */
    async update(id, { data }, authData) {
        ...
        try {
             ...
             * await sanitize data here
             */
            data = await translation_namespace_sanitizers_1.default.sanitizeUpdateBody(data, authData);
            /**
             * Validate data here
             */
            const { error } = translation_namespace_validators_1.default.validateUpdateBody(data);
            if (error)
                throw error;
            /**
             ...
             */
            const doc = await this.translationNamespaceModel.findByIdAndUpdate(id, Object.assign(Object.assign({}, docObject), { $addToSet: {
             ...
             */
            this.eventDispatcher.dispatch(events_config_1.default.content.translation.namespace.updated, { data: doc });
            const result = {
                data: (0, general_mappers_1.mapDocumentToExposed)(doc)
            };
            /**
    ...
    */
    async delete(id, authData) {
        ...
        try {
            ...
            this.eventDispatcher.dispatch(events_config_1.default.content.translation.namespace.deleted, { data: doc });
            const result = {
                data: {
                    deleted: true
                }
    ...
    */
    async restore(id, authData) {
        ...
        try {
            ...
            if (!doc)
                throw new exceptions_1.default.ItemNotFoundException('Object not found');
            this.eventDispatcher.dispatch(events_config_1.default.content.translation.namespace.restored, { data: doc });
            const result = {
                data: {
                    restored: true
                }
...
TranslationNamespacesService = __decorate([
    (0, typedi_1.Service)(),
...
], TranslationNamespacesService);
exports.default = TranslationNamespacesService;
//# sourceMappingURL=translation.namespaces.service.js.map