 ...
 * @description
 */
let TranslationNamespacesService = class TranslationNamespacesService extends BaseService {
    ...
    */
    ...
    async create({ data }, authData, opt) {
        ...
        try {
            ...
            this.eventDispatcher.dispatch(events.content.translation.namespace.created, { data: doc });
            const result = {
                data: mapDocumentToExposed(doc)
            };
            /**
    ...
    */
    async update(id, { data }, authData) {
        ...
        try {
             ...
             */
            this.eventDispatcher.dispatch(events.content.translation.namespace.updated, { data: doc });
            const result = {
                data: mapDocumentToExposed(doc)
            };
            /**
    ...
    */
    async delete(id, authData) {
        ...
        try {
            ...
            this.eventDispatcher.dispatch(events.content.translation.namespace.deleted, { data: doc });
            const result = {
                data: {
                    deleted: true
                }
    ...
    */
    async restore(id, authData) {
        ...
        try {
            ...
            if (!doc)
                throw new exceptions.ItemNotFoundException('Object not found');
            this.eventDispatcher.dispatch(events.content.translation.namespace.restored, { data: doc });
            const result = {
                data: {
                    restored: true
                }
...
export default TranslationNamespacesService;
