 ...
 * @description
 */
let TaxonomiesService = class TaxonomiesService extends BaseService {
    ...
    */
    ...
    _applyFilters({ query, q, totalQ, opt, authData }) {
        ...
        if (TaxonomySchemaFields['tracking_id']) {
            filter = createStringFilter(q, totalQ, filters['tracking_id'], 'tracking_id');
            q = filter.q;
            totalQ = filter.totalQ;
        }
        // -- name
    ...
    */
    ...
    async create({ data }, authData, opt) {
        ...
        try {
            ...
            this.eventDispatcher.dispatch(events.content.taxonomy.created, { data: doc });
            const result = {
                data: mapDocumentToExposed(doc)
            };
            /**
    ...
    */
    async update(id, { data }, authData) {
        ...
        try {
             ...
             */
            this.eventDispatcher.dispatch(events.content.taxonomy.updated, { data: doc });
            const result = {
                data: mapDocumentToExposed(doc)
            };
            /**
    ...
    */
    async delete(id, authData) {
        ...
        try {
            ...
            this.eventDispatcher.dispatch(events.content.taxonomy.deleted, { data: doc });
            const result = {
                data: {
                    deleted: true
                }
    ...
    */
    async restore(id, authData) {
        ...
        try {
            ...
            if (!doc)
                throw new exceptions.ItemNotFoundException('Object not found');
            this.eventDispatcher.dispatch(events.content.taxonomy.restored, { data: doc });
            const result = {
                data: {
                    restored: true
                }
