...
const taxonomy_sanitizers_1 = __importDefault(require("../../../utils/sanitizers/taxonomy.sanitizers"));
const taxonomy_validators_1 = __importDefault(require("../../../utils/validators/taxonomy.validators"));
const taxonomy_model_1 = require("../models/taxonomy.model");
/**
 * @description
 */
let TaxonomiesService = class TaxonomiesService extends base_service_1.default {
    ...
    */
    ...
    _applyFilters({ query, q, totalQ, opt, authData }) {
        ...
        // -- attributed:app
        if (taxonomy_model_1.TaxonomySchemaFields['app']) {
    ...
    async list(query, authData, opt = {
        ...
        try {
            ...
            let q = this.taxonomyModel.find();
            let totalQ = this.taxonomyModel.where();
            /**
             * Apply filters
             */
    ...
    */
    ...
    async create({ data }, authData, opt) {
        ...
        try {
             ...
             */
            data = await taxonomy_sanitizers_1.default.sanitizeCreateBody(data, authData);
            /**
             * Validate data here
             */
            const { error } = taxonomy_validators_1.default.validateCreateBody(data);
            if (error)
                throw error;
            let {} = data;
            /**
             ...
             * Create tracking ID
             */
            if (taxonomy_model_1.TaxonomySchemaFields['tracking_id'] && Object.keys(tracking_id_constants_1.ITEM_SHORTCUTS).includes(this.ENTITY)) {
                docObject['tracking_id'] = await (0, tracking_id_utilities_1.createTrackingId)(this.ENTITY, this.taxonomyModel);
            }
            /**
             * Create search meta
             */
            if (taxonomy_model_1.TaxonomySchemaFields['search_meta']) {
            ...
            this.eventDispatcher.dispatch(events_config_1.default.content.taxonomy.created, { data: doc });
            const result = {
                data: (0, general_mappers_1.mapDocumentToExposed)(doc)
            };
            /**
    ...
    */
    async update(id, { data }, authData) {
        ...
        try {
             ...
             * await sanitize data here
             */
            data = await taxonomy_sanitizers_1.default.sanitizeUpdateBody(data, authData);
            /**
             * Validate data here
             */
            const { error } = taxonomy_validators_1.default.validateUpdateBody(data);
            if (error)
                throw error;
            /**
             ...
             */
            const doc = await this.taxonomyModel.findByIdAndUpdate(id, Object.assign(Object.assign({}, docObject), { $addToSet: {
             ...
             */
            this.eventDispatcher.dispatch(events_config_1.default.content.taxonomy.updated, { data: doc });
            const result = {
                data: (0, general_mappers_1.mapDocumentToExposed)(doc)
            };
            /**
    ...
    */
    async delete(id, authData) {
        ...
        try {
            ...
            this.eventDispatcher.dispatch(events_config_1.default.content.taxonomy.deleted, { data: doc });
            const result = {
                data: {
                    deleted: true
                }
    ...
    */
    async restore(id, authData) {
        ...
        try {
            ...
            if (!doc)
                throw new exceptions_1.default.ItemNotFoundException('Object not found');
            this.eventDispatcher.dispatch(events_config_1.default.content.taxonomy.restored, { data: doc });
            const result = {
                data: {
                    restored: true
                }
...
exports.default = TaxonomiesService;
