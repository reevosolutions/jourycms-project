...
import ReviewSanitizers from '../sanitizers/review.sanitizers';
import ReviewValidators from '../validators/review.validators';
import { ReviewSchemaFields } from '../models/review.model';
/**
 * @description
 */
let ReviewsService = class ReviewsService extends BaseService {
    ...
    */
    ...
    async create({ data }, authData, opt) {
        ...
        try {
            ...
            this.eventDispatcher.dispatch(events.content.review.created, { data: doc });
            const result = {
                data: mapDocumentToExposed(doc)
            };
            /**
    ...
    */
    async update(id, { data }, authData) {
        ...
        try {
             ...
             */
            this.eventDispatcher.dispatch(events.content.review.updated, { data: doc });
            const result = {
                data: mapDocumentToExposed(doc)
            };
            /**
    ...
    */
    async delete(id, authData) {
        ...
        try {
            ...
            this.eventDispatcher.dispatch(events.content.review.deleted, { data: doc });
            const result = {
                data: {
                    deleted: true
                }
    ...
    */
    async restore(id, authData) {
        ...
        try {
            ...
            if (!doc)
                throw new exceptions.ItemNotFoundException('Object not found');
            this.eventDispatcher.dispatch(events.content.review.restored, { data: doc });
            const result = {
                data: {
                    restored: true
                }
