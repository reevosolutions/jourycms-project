...
const review_sanitizers_1 = __importDefault(require("../../../utils/sanitizers/review.sanitizers"));
const review_validators_1 = __importDefault(require("../../../utils/validators/review.validators"));
const review_model_1 = require("../models/review.model");
/**
 * @description
 */
let ReviewsService = class ReviewsService extends base_service_1.default {
    ...
    */
    ...
    _applyFilters({ query, q, totalQ, opt, authData }) {
        ...
        // -- attributed:app
        if (review_model_1.ReviewSchemaFields['app']) {
    ...
    async list(query, authData, opt = {
        ...
        try {
            ...
            let q = this.reviewModel.find();
            let totalQ = this.reviewModel.where();
            /**
             * Apply filters
             */
    ...
    */
    ...
    async create({ data }, authData, opt) {
        ...
        try {
             ...
             */
            data = await review_sanitizers_1.default.sanitizeCreateBody(data, authData);
            /**
             * Validate data here
             */
            const { error } = review_validators_1.default.validateCreateBody(data);
            if (error)
                throw error;
            let {} = data;
            /**
             ...
             * Create tracking ID
             */
            if (review_model_1.ReviewSchemaFields['tracking_id'] && Object.keys(tracking_id_constants_1.ITEM_SHORTCUTS).includes(this.ENTITY)) {
                docObject['tracking_id'] = await (0, tracking_id_utilities_1.createTrackingId)(this.ENTITY, this.reviewModel);
            }
            /**
             * Create search meta
             */
            if (review_model_1.ReviewSchemaFields['search_meta']) {
            ...
            this.eventDispatcher.dispatch(events_config_1.default.content.review.created, { data: doc });
            const result = {
                data: (0, general_mappers_1.mapDocumentToExposed)(doc)
            };
            /**
    ...
    */
    async update(id, { data }, authData) {
        ...
        try {
             ...
             * await sanitize data here
             */
            data = await review_sanitizers_1.default.sanitizeUpdateBody(data, authData);
            /**
             * Validate data here
             */
            const { error } = review_validators_1.default.validateUpdateBody(data);
            if (error)
                throw error;
            /**
             ...
             */
            const doc = await this.reviewModel.findByIdAndUpdate(id, Object.assign(Object.assign({}, docObject), { $addToSet: {
             ...
             */
            this.eventDispatcher.dispatch(events_config_1.default.content.review.updated, { data: doc });
            const result = {
                data: (0, general_mappers_1.mapDocumentToExposed)(doc)
            };
            /**
    ...
    */
    async delete(id, authData) {
        ...
        try {
            ...
            this.eventDispatcher.dispatch(events_config_1.default.content.review.deleted, { data: doc });
            const result = {
                data: {
                    deleted: true
                }
    ...
    */
    async restore(id, authData) {
        ...
        try {
            ...
            if (!doc)
                throw new exceptions_1.default.ItemNotFoundException('Object not found');
            this.eventDispatcher.dispatch(events_config_1.default.content.review.restored, { data: doc });
            const result = {
                data: {
                    restored: true
                }
