...
const translation_project_sanitizers_1 = __importDefault(require("../../../utils/sanitizers/translation.project.sanitizers"));
const translation_project_validators_1 = __importDefault(require("../../../utils/validators/translation.project.validators"));
...
let TranslationProjectsService = class TranslationProjectsService extends base_service_1.default {
    ...
    async list(query, authData, opt = {
        ...
        try {
            ...
            let q = this.translationProjectModel.find();
            let totalQ = this.translationProjectModel.where();
            /**
             * Apply filters
             */
    ...
    */
    async update(id, { data }, authData) {
        ...
        try {
             ...
             */
            const doc = await this.translationProjectModel.findByIdAndUpdate(id, Object.assign(Object.assign({}, docObject), { $addToSet: {
