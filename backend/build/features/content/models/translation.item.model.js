 ...
 *
 */
const TranslationItemSchema = new Schema(TranslationItemSchemaFields, {
    timestamps: {
 ...
 *
 */
const TranslationItem = (models === null || models === void 0 ? void 0 : models.TranslationItem) || model('TranslationItem', TranslationItemSchema);
/**
