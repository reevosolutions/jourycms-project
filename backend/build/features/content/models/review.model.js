...
const ReviewSchemaFields = Object.assign(Object.assign({ 
     ...
     * Specific to Entity
     */
    article: { type: Schema.Types.ObjectId, ref: 'Article', required: true }, slug: { type: String }, 
    // 
    body: { type: String }, body_unformatted: { type: String }, body_structured: { type: Schema.Types.Mixed }, value: { type: Number, default: 0 } });
/**
 ...
 *
 */
const Review = (models === null || models === void 0 ? void 0 : models.Review) || model('Review', ReviewSchema);
/**
