...
exports.TICKET_PREDEFINED_TYPES = exports.TICKET_FIELD_TYPES = exports.ticketResponseStatuses = exports.ticketStatuses = void 0;
exports.ticketStatuses = [
    "new",
    "open",
    "rejected",
    "closed",
...
exports.ticketResponseStatuses = ["new", "open", "closed"];
exports.TICKET_FIELD_TYPES = [
    "number",
    "boolean",
    "phones",
    "date",
...
exports.TICKET_PREDEFINED_TYPES = {
    Dev: {
        name: "Test Only",
        identifier: "DEV",
        description: "",
