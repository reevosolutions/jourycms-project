...
export default class RolesClient extends BaseClient {
  ...
  // listRolePermissions
  async listRolePermissions(id: string, params?: ApiAlias.ListRolePermissions.Request, config?: SDK.TRequestConfig): Promise<SDK.TResponseDatum<ApiAlias.ListRolePermissions.Response>> {
  ...
  // changePermissions
  async changePermissions(id: string, data: ApiAlias.ChangePermissions.Request, config?: SDK.TRequestConfig): Promise<SDK.TResponseDatum<ApiAlias.ChangePermissions.Response>> {
