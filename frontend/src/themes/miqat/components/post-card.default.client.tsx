...
export type DefaultPostCard_ClientProps = JouryCMS.Theme.ComponentProps & {
  data: EntityAlias;
  edge?: Partial<ApiAlias.List.Response["edge"]>;
  articleTypeSlug: `${ArticleTypeSlug}`;
};

const DefaultPostCard_Client: React.FC<DefaultPostCard_ClientProps> = ({
  data,
  edge,
  articleTypeSlug,
}) => {
...
export default DefaultPostCard_Client;
