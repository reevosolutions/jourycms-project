  ...
  return (
    <footer className="jcms-footer bg-darkblue-950 text-white">
      <div className="grid grid-cols-1 lg:grid-cols-3">
        {/* about */}
        <div className="bg-darkblue-900 flex items-center justify-center px-6 py-6 lg:py-16">
          <div className="w-80 max-w-full lg:w-auto">
            <h2
              className="text-center text-8xl font-bold mb-8 "
              title={getWebsiteConfig()?.name}
            >
            ...
            <div className="mt-16 flex flex-col items-center gap-4 text-white lg:flex-row lg:gap-8">
                ...
                {getWebsiteConfig()?.social_links?.map(network =>
                  network.url ? (
                    <a
                      ...
                      key={network.network}
                      href={network.url}
                      className="text-darkblue-900 hocus:bg-red2-700 rounded-full bg-white p-2 transition-all duration-200"
                    >
        ...
        {/* links */}
        <div className="items-top bg-darkblue-900 flex justify-center px-6 py-6 lg:py-24">
            ...
            <div className="mt-16 flex items-center gap-8 text-2xl">
              <ul>
                <li className="">
                  <Link
                    href="/"
                    className="hocus:text-beige-50 text-white transition-all duration-200"
                  >
                    الرئيسية
                  </Link>
                </li>
        ...
        {/* contact */}
        <div className="items-top bg-darkblue-950 text-darkblue-50 flex justify-center px-6 py-6 lg:py-24">
          <div className="w-80 max-w-full">
            <h2 className="text-3xl font-bold">الاتصال بنا</h2>

            <div className="mt-16 flex flex-col gap-4 text-2xl">
              <div className="flex gap-3">
                <Icons.Marker className="text-darkblue-500 mt-1 h-6 w-6" />
                <div
                  className=""
                  dangerouslySetInnerHTML={{
              ...
              <div className="flex gap-3">
                <Icons.Envelope className="text-darkblue-500 mt-1 h-6 w-6" />
                <div className="">
                  <a
              ...
              <div className="flex gap-3">
                <Icons.Phone className="text-darkblue-500 mt-1 h-6 w-6" />
                <div className="">
                  <a
