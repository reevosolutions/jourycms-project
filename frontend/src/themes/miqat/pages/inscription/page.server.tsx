import InscriptionForm from "@/themes/miqat/components/forms/inscription.form";
import * as React from "react";
import DefaultLayout from "../../layouts/default.layout";
import WithoutHeaderAndFooterLayout from "../../layouts/without-header-and-footer.layout";
...
const ThemePage_Server: React.FC<PageProps> = ({
	...
	/* -------------------------------------------------------------------------- */
	return (
		<WithoutHeaderAndFooterLayout route={route}>
			<div className=" bg-gradient-to-t from-beige-50/20 to-white">
						...
						<div className="header">
							<div className="mx-auto">
								<svg
									...
									viewBox="0 0 365.3 219.6"
									className="mx-auto mb-8 w-48"
								>
									<g>
										<path
											fill="#000"
											d="M0 125.8 70.6 41l84.7 70.6-70.6 84.7z"
										/>
										<g fill="#cb9903">
							...
							<h1 className="mb-2 text-center text-3xl font-bold text-darkblue-600">
								الشركة السعودية ميقات
							</h1>
							<h2 className="mb-6 text-center text-xl text-darkblue-500">
								للحلول البرمجية في مجال الحج والعمرة
							</h2>
							<p className="mb-4 text-center text-lg font-medium text-darkblue-600 md:text-xl">
								تفتتح خدماتها بالجزائر لصالح وكالات السياحة والسفر
							</p>
							<p className="mb-8 text-center font-bold text-red2-600">
								انضموا الينا الان
							</p>
						</div>
						<InscriptionForm />
