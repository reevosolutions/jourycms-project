...
export type HomepageContentBidsSectionProps =
  JouryCMS.Theme.ComponentProps & {};

const HomepageContentBidsSection: React.FC<HomepageContentBidsSectionProps> = ({
  children,
}) => {
  return <div className="container mx-auto">bids</div>;
};
