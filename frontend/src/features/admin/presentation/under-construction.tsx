...
const UnderConstrunction: React.FC<{}> = () => {
  return (
    <div className="m min-h-screen-90 flex flex-col justify-center items-center gap-12  -ml-4 -mb-4 relative overflow-hidden">
    <div className="absolute bottom-0 left-0 -translate-x-1/2 translate-y-1/3 opacity-5">
        <svg xmlns="http://www.w3.org/2000/svg" width="800" height="800" viewBox="0 0 444.2 444.2" fill="currentColor">
          <path
      ...
      <div className=" text-primary-300 relative z-10">
        <svg width="200px" height="200px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
          <path fill='none' stroke='currentColor' strokeLinecap='round' strokeLinejoin='round' d="M17.5174,14.4594a4.9032,4.9032,0,1,1,5.5542.0484" />
          <path fill='none' stroke='currentColor' strokeLinecap='round' strokeLinejoin='round' d="M8.14,25.6471a4.9032,4.9032,0,1,1-.2391,5.5493" />
          <path fill='none' stroke='currentColor' strokeLinecap='round' strokeLinejoin='round' d="M17.5174,14.4594c.3291.6149.2658,1.66-1.29,1.8469h-9.65v8.2406a1.071,1.071,0,0,0,1.563,1.1" />
          <path fill='none' stroke='currentColor' strokeLinecap='round' strokeLinejoin='round' d="M7.9013,31.1964a.9506.9506,0,0,0-1.3239,1.0862v7.9311h20.5" />
          <path fill='none' stroke='currentColor' strokeLinecap='round' strokeLinejoin='round' d="M18.8064,34.4526l2.5516,4.4405c3.0683-1.8143,6.2015.008,6.2015,3.5672h5.097c0-3.5591,2.8385-5.2144,6.2164-3.5592l2.5534-4.45c-3.1492-1.8069-3.1514-5.3385-.0011-7.1506L38.873,22.8637c-3.0354,1.8025-6.2164.004-6.2164-3.5715H27.56c0,3.5755-3.1332,5.374-6.2037,3.5755l-2.5495,4.3529c3.2274,1.89,3.04,5.4852,0,7.232Z" />
          <circle fill='none' stroke='currentColor' strokeLinecap='round' strokeLinejoin='round' cx="30.1163" cy="30.8763" r="4.1677" />
          <path fill='none' stroke='currentColor' strokeLinecap='round' strokeLinejoin='round' d="M23.0716,14.5079c-.468.3765-.5805,1.6076,1.1868,1.7985h8.3981v2.9858" />
        </svg>
      </div>
      <p className=" text-slate-500 font-semibold px-8 max-w-lg text-center">
        {"هذه الميزة غير متوفرة في هذا الإصدار من "} <span className=' text-xs font-semibold'>® Joury CMS</span><br />
        {"يرجى زيارة الموقع الرسمي لمزيد من المعلومات."}
        <span className="block text-sm text-primary-400 mt-2">
          {"لكن يمكنك ضبط هذا الجزء من جانب إعدادات الثيم"}
        </span>
      </p>
    </div>
  )
