      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper flex min-h-svh w-full flex-row-reverse has-[[data-variant=inset]]:bg-sidebar rtl:flex-row-reverse",
              className,
            )}
            ref={ref}
            {...props}
      ...
      >
        ...
        <div
          className={cn(
            ...
            side === "start"
              ? "left-0 group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)] rtl:left-auto rtl:right-0"
